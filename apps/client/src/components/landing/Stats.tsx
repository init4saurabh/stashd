const stats = [
  { value: "3s", label: "TO SAVE A LINK", border: true },
  { value: "AI", label: "AUTO SUMMARIES", border: true },
  { value: "14d", label: "STALE-LINK ALERTS", border: true },
  { value: "100%", label: "YOUR OWN VAULT", border: false },
];

export default function Stats() {
  return (
    <section className="flex flex-col w-full bg-[#FFD600] py-12 px-6 md:py-[80px] md:px-[120px]">
      <span className="font-ibm-mono text-[12px] font-bold text-[#0A0A0A] tracking-[3px]">[03] // WHY STASHD</span>
